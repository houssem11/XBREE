...
public class AddEvent extends AppCompatActivity implements View.OnClickListener {
                    ...
                    acceptButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            addEvenement(nom.getText().toString(), type.getText().toString(), datedebut.getText().toString(), datefin.getText().toString(), Integer.parseInt(distance.getText().toString()),
                                    lieu.getText().toString(), Integer.parseInt(contact.getText().toString()), Integer.parseInt(prix.getText().toString()), camp_desc.getText().toString(), Integer.parseInt(nbPlace.getText().toString()));
    ...
    private void addEvenement(final String nom_evenement, final String type_evenement, final String date_debut_evenement, final String date_fin_evenement, final int camp_distanse,
        ...
        Evenement tmpUser = new Evenement(nom_evenement,type_evenement,date_debut_evenement,date_fin_evenement,camp_distanse,camp_lieu,camp_contact,description_evenement,camp_prix,nbplace_evenement);
